...
using Aether.Physics2D.Common.Decomposition.CDT;
using Aether.Physics2D.Common.Decomposition.CDT.Delaunay;
using Aether.Physics2D.Common.Decomposition.CDT.Delaunay.Sweep;
using Aether.Physics2D.Common.Decomposition.CDT.Polygon;
using Aether.Physics2D.Common.Maths;

namespace Aether.Physics2D.Common.Decomposition
{
    /// <summary>
